...
if (window.innerWidth > 768) {
  ...
  // Optional: kill all ScrollTriggers if already initialized
...
if (window.innerWidth < 768) {
  let mobileAnimation = () => {
    ...
    tlm.from(".hdng-service", {
      y: -100,
      opacity: 0,
      duration: 0.8,
    });
    tlm.from("#srvc-sctn-1", {
      x: -100,
      opacity: 0,
      duration: 0.8,
    });
    tlm.from("#srvc-sctn-2", {
      y: -100,
      opacity: 0,
      duration: 0.8,
    });
    tlm.from("#srvc-sctn-3", {
      x: -100,
      opacity: 0,
      duration: 0.8,
    });
    tlm.from("#sctn-btm-srvc-sctn-1",{
      x:-100,
      opacity:0,
      duration:0.8,
    });
    tlm.from("#sctn-btm-srvc-sctn-2",{
      x:100,
      opacity:0,
      duration:0.8,
    });
...
let back = document.querySelectorAll(".menubar-slide a");
...
tlmenu.to(".menubar-slide",{
  right:0,
  duration:0.7,
});
tlmenu.from(".menubar-slide a",{
  x:100,
  opacity:0,
  duration:0.5,
  stagger:0.1,
});
tlmenu.from(".menubar-slide i",{
  opacity: 0,
  duration: 0.3,
})
tlmenu.pause();
